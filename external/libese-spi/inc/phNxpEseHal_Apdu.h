 ...
 *          ESESTATUS_INVALID_PARAMETER - If any invalid parameter passed from application \n
 *          ESESTATUS_INVALID_CLA - If application passed cla value 0xFF \n
 *          ESESTATUS_INVALID_BUFFER - If any invalid buffer received \n
 *          ESESTATUS_INVALID_LE_TYPE - If any invalid LE type found \n
