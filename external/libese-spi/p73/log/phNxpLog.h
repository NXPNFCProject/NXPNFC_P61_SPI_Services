...
#define NAME_NXPLOG_PAL_LOGLEVEL            "NXPLOG_PAL_LOGLEVEL"
...
#define PROP_NAME_NXPLOG_ESELIB_LOGLEVEL       "ese.nxp_log_level_eselib"
#define PROP_NAME_NXPLOG_SPI_LOGLEVEL          "ese.nxp_log_level_spi"
#define PROP_NAME_NXPLOG_FWDNLD_LOGLEVEL       "ese.nxp_log_level_dnld"
#define PROP_NAME_NXPLOG_PAL_LOGLEVEL          "ese.nxp_log_level_pal"
...
#    define NXPLOG_ESELIB_D(...)  {if(gLog_level.eselib_log_level >= NXPLOG_LOG_DEBUG_LOGLEVEL) LOG_PRI(ANDROID_LOG_DEBUG,NXPLOG_ITEM_ESELIB,__VA_ARGS__);}
#    define NXPLOG_ESELIB_W(...)  {if(gLog_level.eselib_log_level >= NXPLOG_LOG_WARN_LOGLEVEL) LOG_PRI(ANDROID_LOG_WARN,NXPLOG_ITEM_ESELIB,__VA_ARGS__);}
#    define NXPLOG_ESELIB_E(...)  {if(gLog_level.eselib_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL) LOG_PRI(ANDROID_LOG_ERROR,NXPLOG_ITEM_ESELIB,__VA_ARGS__);}
#else
...
#    define NXPLOG_PAL_D(...)  {if(gLog_level.pal_log_level >= NXPLOG_LOG_DEBUG_LOGLEVEL) LOG_PRI(ANDROID_LOG_DEBUG,NXPLOG_ITEM_PAL,__VA_ARGS__);}
#    define NXPLOG_PAL_W(...)  {if(gLog_level.pal_log_level >= NXPLOG_LOG_WARN_LOGLEVEL) LOG_PRI(ANDROID_LOG_WARN,NXPLOG_ITEM_PAL,__VA_ARGS__);}
#    define NXPLOG_PAL_E(...)  {if(gLog_level.pal_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL) LOG_PRI(ANDROID_LOG_ERROR,NXPLOG_ITEM_PAL,__VA_ARGS__);}
#else
#    define NXPLOG_PAL_D(...)
#    define NXPLOG_PAL_W(...)
#    define NXPLOG_PAL_E(...)
...
#if (ENABLE_LIB_TRACES == TRUE )
#    define NXPLOG_ESELIB_ENTRY() NXPLOG_FUNC_ENTRY(NXPLOG_ITEM_ESELIB)
#    define NXPLOG_ESELIB_EXIT()  NXPLOG_FUNC_EXIT(NXPLOG_ITEM_ESELIB)
#else
#    define NXPLOG_ESELIB_ENTRY()
#    define NXPLOG_ESELIB_EXIT()
#endif
