 ...
 * \param[out]      pphNxpEse_7816_rpdu_t  - RSP from p61(all required memory allocated by caller)
 *
 * \retval ESESTATUS_SUCCESS - On Success #pphNxpEse_7816_rpdu_t all fields are filled correctly.
 *          else proper error code.
 * \retval ESESTATUS_INVALID_PARAMETER - If any invalid buffer passed from application \n
